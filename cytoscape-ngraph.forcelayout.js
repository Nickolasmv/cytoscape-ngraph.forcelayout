...
function physicsSimulator(settings) {
  ...
  function accumulateForces() {
   ...
   return  pq.reduce(Q.when, Q(true)).then(function(){
      i = springs.length;
      while(i--) {
...
},{"./lib/bounds":10,"./lib/createBody":11,"./lib/dragForce":12,"./lib/eulerIntegrator":13,"./lib/qtreebh":14,"./lib/spring":15,"./lib/springForce":16,"Q":17,"ngraph.events":18,"ngraph.expose":2,"ngraph.merge":7}],10:[function(_dereq_,module,exports){
...
},{"Q":17,"ngraph.random":19}],15:[function(_dereq_,module,exports){
...
},{"Q":1,"ngraph.forcelayout.v2":3,"ngraph.graph":5,"underscore":21}],23:[function(_dereq_,module,exports){
'use strict';
